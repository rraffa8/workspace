/* Based on CPU DB MC9S08SE8_28, version 3.00.014 (RegistersPrg V2.32) */
/*
** ###################################################################
**     Filename  : mc9s08se8.h
**     Processor : MC9S08SE8CWL
**     FileFormat: V2.32
**     DataSheet : MC9S08SE8RM Rev. 2 12/2008
**     Compiler  : CodeWarrior compiler
**     Date/Time : 5.10.2010, 13:56
**     Abstract  :
...
**      - 27.1.2009, V3.00.0:
**              - Unused vector space 0xFFC0:0xFFCB made available for use as general flash memory: removed reserved interrupt vectors VReserved26..31.  
**              -   REASON: Reference Manual update (to Rev. 2 12/2008).
**
...
#define VectorNumber_Vkeyboard          20U
...
typedef union {
  ...
  struct {
    ...
    byte TPM1PS      :1;                                       /* TPM1 Pins Select */
    byte             :1; 
    byte             :1; 
...
#define SOPT1_TPM1PS                    _SOPT1.Bits.TPM1PS
...
#define PTAPE_PTAPE_5_MASK              224U
#define PTAPE_PTAPE_5_BITNUM            5U
...
/*** GNGC - Ganged Output Drive Control Register; 0x0000184B ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile GNGCSTR _GNGC @0x0000184B;
...
#define VectorNumber_VReserved29         This_symb_has_been_depreciated
#define VectorNumber_VReserved28         This_symb_has_been_depreciated
#define VectorNumber_VReserved27         This_symb_has_been_depreciated
#define VectorNumber_VReserved26         This_symb_has_been_depreciated
#define VReserved31                      This_symb_has_been_depreciated
#define VReserved30                      This_symb_has_been_depreciated
#define VReserved29                      This_symb_has_been_depreciated
#define VReserved28                      This_symb_has_been_depreciated
#define VReserved27                      This_symb_has_been_depreciated
#define VReserved26                      This_symb_has_been_depreciated
#endif
